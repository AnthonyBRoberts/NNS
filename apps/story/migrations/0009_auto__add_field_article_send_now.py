...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.send_now'
        db.add_column('story_article', 'send_now',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.send_now'
        db.delete_column('story_article', 'send_now')
    ...
    models = {
        ...
        'story.article': {
            ...
            'publish_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 10, 0, 0)'}),
