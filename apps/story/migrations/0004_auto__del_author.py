...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('story_author')

        # Removing M2M table for field authors on 'Article'
        db.delete_table('story_article_authors')

        # Adding M2M table for field author on 'Article'
        db.create_table('story_article_author', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('article', models.ForeignKey(orm['story.article'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('story_article_author', ['article_id', 'user_id'])


    def backwards(self, orm):
        # Adding model 'Author'
        db.create_table('story_author', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('story', ['Author'])

        # Adding M2M table for field authors on 'Article'
        db.create_table('story_article_authors', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('article', models.ForeignKey(orm['story.article'], null=False)),
            ('author', models.ForeignKey(orm['story.author'], null=False))
        ))
        db.create_unique('story_article_authors', ['article_id', 'author_id'])

        # Removing M2M table for field author on 'Article'
        db.delete_table('story_article_author')
    ...
    models = {
        ...
        'story.article': {
            ...
            'author': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['auth.User']", 'symmetrical': 'False'}),
            ...
            'publish_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 27, 0, 0)', 'null': 'True', 'blank': 'True'}),
