...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('story_article', 'text', self.gf('django.db.models.fields.CharField')(max_length=10000))
    ...
    models = {
        ...
        'story.article': {
            ...
            'publish_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 24, 0, 0)'}),
