...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('story_article', 'author',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('story_article', 'author_id')
    ...
    models = {
        ...
        'story.article': {
            ...
            'publish_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 1, 0, 0)'}),
