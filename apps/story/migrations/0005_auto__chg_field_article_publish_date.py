...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('story_article', 'publish_date', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Article.publish_date'
        db.alter_column('story_article', 'publish_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
