...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('story_article', 'publish_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 4, 24, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.publish_date'
        db.delete_column('story_article', 'publish_date')
