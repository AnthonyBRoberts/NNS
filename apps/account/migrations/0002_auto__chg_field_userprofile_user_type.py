...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('account_userprofile', 'user_type', self.gf('django.db.models.fields.CharField')(max_length=25))

    def backwards(self, orm):

        # Changing field 'UserProfile.user_type'
        db.alter_column('account_userprofile', 'user_type', self.gf('django.db.models.fields.CharField')(max_length=10))
