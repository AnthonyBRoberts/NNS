...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.pub_name'
        db.add_column('account_userprofile', 'pub_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.pub_type'
        db.add_column('account_userprofile', 'pub_type',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.pub_name'
        db.delete_column('account_userprofile', 'pub_name')

        # Deleting field 'UserProfile.pub_type'
        db.delete_column('account_userprofile', 'pub_type')
