...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('account_userprofile', 'phone', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.phone'
        db.alter_column('account_userprofile', 'phone', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
