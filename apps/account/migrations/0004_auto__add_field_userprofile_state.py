...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'account_userprofile', 'state',
                      self.gf('localflavor.us.models.USStateField')(default='NE', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.state'
        db.delete_column(u'account_userprofile', 'state')
